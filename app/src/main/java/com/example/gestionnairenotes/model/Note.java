...
public class Note {
    ...
    // Constructeur personnalisé indispensable pour NoteFormActivity (3 arguments)
    public Note(String titre, String contenu, String couleur) {
        this.titre = titre;
        this.contenu = contenu;
        this.couleur = couleur;
        this.favori = false; // Par défaut, la note n'est pas en favori
        this.date = System.currentTimeMillis(); // Assigne automatiquement l'heure actuelle
    }

    // Constructeur complet : pour créer une note avec toutes ses informations d'un coup
    public Note(long id, String titre, String contenu, String couleur, long date, boolean favori) {
        this.id = id;
        this.titre = titre;
        this.contenu = contenu;
        this.couleur = couleur;
    ...
    // Correction ici : changement du type int vers long
