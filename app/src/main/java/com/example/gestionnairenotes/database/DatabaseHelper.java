...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Alias pour assurer la compatibilité exacte avec NoteDao
    public static final String COL_ID = COLUMN_ID;
    public static final String COL_TITRE = COLUMN_TITRE;
    public static final String COL_CONTENU = COLUMN_CONTENU;
    public static final String COL_COULEUR = COLUMN_COULEUR;
    public static final String COL_DATE = COLUMN_DATE;
    public static final String COL_FAVORI = COLUMN_FAVORI;
